...
#define STATSF_SET_EXPECTED_MEAN(ptr,val)       ((ptr)->expected_mean = (val))
#define STATSF_SET_TMP_FILE(ptr,val)            ((ptr)->tmp_file = (val))
#define STATSF_SET_TMP_FILE_CPY(ptr,val,array_size) \
    for (size_t c = 0; c < (array_size); ++c) (ptr)->tmp_file[c] = val[c];
#define STATSF_SET_TMP_FILE_AE(ptr,c,val)       ((ptr)->tmp_file[c] = (val))
